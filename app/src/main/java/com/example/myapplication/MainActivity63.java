...
public class MainActivity63 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (kol[0] != 0) {
             ...
             ProgressBar ber=findViewById(R.id.progressBar3);
             TextView timer=findViewById(R.id.timer3);
            if(dif==4){
                ber.setVisibility(View.GONE);
                timer.setText("Режим практики");

            }
            Button r1=findViewById(R.id.b1);
            Button r2=findViewById(R.id.b2);
            Button r3=findViewById(R.id.b3);
            Button r4=findViewById(R.id.b4);
            Button r5=findViewById(R.id.b5);
             int time=60000;
             if(dif==1){
                 time=30000;
                 ber.setMax(30);
             ...
             int finalTime = time;
            String [] sps1={"","his","one","have","this","from","hot","but ","had","which","hello"};
            String [] sps2={"","want","also","read","act","went","mother","world ","father","place","tell"};
            String [] sps3={"","each","live","where","after","back","little ","man","show ","give","our",};
            String [] sps4={"","test","record","common","gold","possible","plane","under","dry","ran","game",};
            int y=0;
            int ran= (int) ((Math.random()*3)+1);
            if(dif==1 || dif==4) {
                if (ran == 1) {
                    ran = (int) ((Math.random() * 9) + 1);
                    if (sps1[ran].equals(word_g)) {
                        ran = (int) ((Math.random() * 9) + 1);
                        r1.setText(sps1[ran]);
                    } else {
                        r1.setText(sps1[ran]);
                    }
                    if (sps2[ran].equals(word_g)) {
                        ran = (int) ((Math.random() * 9) + 1);
                        r2.setText(sps2[ran]);
                    } else {
                        r2.setText(sps2[ran]);
